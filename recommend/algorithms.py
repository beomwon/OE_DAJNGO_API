...
● 오늘의 오슐랭 추천메뉴
(꺄아) {mi['menu'][0]['name']} 평점: {str(mi['menu'][0]['aver_rating'])}점
(꺄아) {mi['menu'][1]['name']} 평점: {str(mi['menu'][1]['aver_rating'])}점
(꺄아) {mi['menu'][2]['name']} 평점: {str(mi['menu'][2]['aver_rating'])}점
(꺄아) {mi['menu'][3]['name']} 평점: {str(mi['menu'][3]['aver_rating'])}점
